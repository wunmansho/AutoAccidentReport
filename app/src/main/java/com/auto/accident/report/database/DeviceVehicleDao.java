...
@Dao
public interface DeviceVehicleDao {

    @Query("SELECT * FROM device_vehicle_table ORDER BY DV_ID")
    List<DeviceVehicle> loadAllDeviceVehicles();

    @Insert
    void insertDeviceVehicle(DeviceVehicle deviceVehicle);

    @Update
    void updateDeviceVehicle(DeviceVehicle deviceVehicle);

    @Delete
    void deleteDeviceVehicle(DeviceVehicle deviceVehicle);

    @Query("SELECT * FROM device_vehicle_table WHERE DV_ID = :id")
    DeviceVehicle loadDeviceVehicleById(int id);
}
