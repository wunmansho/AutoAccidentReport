...
public class HeaderItem extends AbstractItem<HeaderItem, HeaderItem.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View headerView) {
            ...
            aboutIcon = headerView.findViewById(R.id.aboutIcon);
            aboutAppName = headerView.findViewById(R.id.aboutName);
            ...
            aboutSpecial1 = headerView.findViewById(R.id.aboutSpecial1);
            aboutSpecial2 = headerView.findViewById(R.id.aboutSpecial2);
            aboutSpecial3 = headerView.findViewById(R.id.aboutSpecial3);
            aboutVersion = headerView.findViewById(R.id.aboutVersion);
            ...
            aboutAppDescription = headerView.findViewById(R.id.aboutDescription);
