...
public class LibraryItem extends AbstractItem<LibraryItem, LibraryItem.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            libraryCreator = itemView.findViewById(R.id.libraryCreator);
            ...
            libraryVersion = itemView.findViewById(R.id.libraryVersion);
            ...
            libraryLicense = itemView.findViewById(R.id.libraryLicense);
